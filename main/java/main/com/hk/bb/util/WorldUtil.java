...
public class WorldUtil
{
	...
	{
		if (MPUtil.isClientSide()) return;
		final boolean isAirAndStay = isAir && canStay && worldObj.isAirBlock(x, y, z) && block.canBlockStay(worldObj, x, y, z);
		final boolean isAirAndNotStay = isAir && !canStay && worldObj.isAirBlock(x, y, z);
		final boolean isNotAirAndStay = canStay && !isAir && block.canBlockStay(worldObj, x, y, z);
		final boolean isNotAirAndNotStay = !isAir && !canStay;
