...
public class ModelMaleChicken extends ModelBase
{
	...
	public ModelMaleChicken()
	{
		...
		body.mirror = false;
		body.addBox(-3.0F, 0.0F, -3.0F, 6, 5, 6);
		...
		leftLeg.setInitialRotationPoint(2.0F, 0.0F, -2.0F);
		...
		rightLeg.setInitialRotationPoint(-3.0F, 0.0F, -2.0F);
		...
		chest.setInitialRotationPoint(-2.0F, 5.0F, -2.0F);
		...
		neck.setInitialRotationPoint(-1.0F, 5.5F, -1.0F);
		...
		leftWing = new MCAModelRenderer(this, "leftWing", 30, 0);
		leftWing.mirror = false;
		leftWing.addBox(0.0F, -4.0F, 0.0F, 1, 4, 4);
		leftWing.setInitialRotationPoint(3.0F, 4.0F, -3.0F);
		...
		rightWing.addBox(-1.0F, -4.0F, 0.0F, 1, 4, 4);
		rightWing.setInitialRotationPoint(-3.0F, 4.0F, -3.0F);
		...
		head.mirror = false;
		head.addBox(-1.0F, 0.0F, -1.0F, 2, 4, 2);
		...
		beak.setInitialRotationPoint(-1.0F, 2.0F, 0.0F);
		...
		waddle.setInitialRotationPoint(-0.5F, 1.0F, 0.5F);
		...
		comb.setInitialRotationPoint(0.0F, 4.0F, 0.0F);
		...
		head2 = new MCAModelRenderer(this, "head2", 0, 8);
		head2.mirror = false;
		head2.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1);
		head2.setInitialRotationPoint(-0.5F, 3.5F, -0.5F);
		head2.setInitialRotationMatrix(new Matrix4f().set(new Quaternion(0.0F, 0.0F, 0.0F, 1.0F)).transpose());
