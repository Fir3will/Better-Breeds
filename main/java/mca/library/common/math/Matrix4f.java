...
public class Matrix4f implements java.io.Serializable
{
	...
	static boolean luDecomposition(double[] matrix0, int[] row_perm)
	{
...

		{
			...
			for (j = 0; j < 4; j++)
			{
				...
				if (imax < 0) throw new RuntimeException("PROBLEM!!! Matrix4f");
	...
	public boolean equals(Matrix4f m1)
	{
		try
		{
			return m00 == m1.m00 && m01 == m1.m01 && m02 == m1.m02 && m03 == m1.m03 && m10 == m1.m10 && m11 == m1.m11 && m12 == m1.m12 && m13 == m1.m13 && m20 == m1.m20 && m21 == m1.m21 && m22 == m1.m22 && m23 == m1.m23 && m30 == m1.m30 && m31 == m1.m31 && m32 == m1.m32 && m33 == m1.m33;
		}
	...
	public boolean equals(Object t1)
	{
		try
		{
			...
			return m00 == m2.m00 && m01 == m2.m01 && m02 == m2.m02 && m03 == m2.m03 && m10 == m2.m10 && m11 == m2.m11 && m12 == m2.m12 && m13 == m2.m13 && m20 == m2.m20 && m21 == m2.m21 && m22 == m2.m22 && m23 == m2.m23 && m30 == m2.m30 && m31 == m2.m31 && m32 == m2.m32 && m33 == m2.m33;
		}
	...
	{
		if (m00 == 1 && m11 == 1 && m22 == 1)
		{
			final float[] m = intoArray();
